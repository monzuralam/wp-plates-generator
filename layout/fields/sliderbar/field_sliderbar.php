<?php
class ATT_Options_sliderbar extends ATT_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('att-opts-jquery-ui-css');
		
		wp_enqueue_script(
			'jquery-slider', 
			ATT_Options_URI.'fields/sliderbar/jquery.ui.slider.js', 
		...
		wp_enqueue_script(
			'att-opts-field-sliderbar-js', 
			ATT_Options_URI.'fields/sliderbar/field_sliderbar.js', 
