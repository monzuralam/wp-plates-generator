<?php
class ATT_Options_color extends ATT_Options{	
	...
	*/
	function enqueue(){
		wp_enqueue_script('att-opts-field-color-js', ATT_Options_URI.'fields/color/field_color.js', array('jquery', 'farbtastic'), time(), true);
	}
