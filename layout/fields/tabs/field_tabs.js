jQuery(document).ready(function($){
	...
	// add
	$('.att-add-tab').click(function(){
		
		// increase tabs counter
		var tabs_counter = $(this).siblings('.att-tabs-count');
	...
	// delete
	$('.att-remove-tab').click(function(e){
		e.preventDefault();
		
		// decrease tabs counter
		var tabs_counter = $(this).parents('td').children('.att-tabs-count');
		tabs_counter.val(tabs_counter.val()*1 - 1);
